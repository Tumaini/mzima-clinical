...
selectMenu2: ["wm.SelectMenu", {"caption":"Clinician","captionSize":"140px","dataField":"dataValue","dataValue":undefined,"desktopHeight":"26px","displayField":"dataValue","formField":"clinician","height":"26px","options":"DNN,GEM,IHU,LAN,SRA,WEL","required":true,"width":"50%"}, {"onchange":"selectMenu2Change"}, {
binding: ["wm.Binding", {}, {}, {
...
clinicalmainLiveVariable2: ["wm.LiveVariable", {"matchMode":"anywhere","orderBy":"desc:insertdate","type":"com.mcddb.data.ClinicalMain"}, {}, {
...
seroNo: ["wm.Text", {"caption":"SEARCH BY SEROLINK NUMBER:","captionSize":"210px","changeOnKey":true,"dataValue":undefined,"displayValue":"","regExp":"[0-9]*","resetButton":true,"width":"400px"}, {}],
...
clinicalmainDojoGrid: ["wm.DojoGrid", {"columns":[{"show":false,"field":"id","title":"Id","width":"80px","align":"right","formatFunc":"","editorProps":{"restrictValues":true},"mobileColumn":false},{"show":true,"field":"date","title":"Date","width":"80px","align":"left","formatFunc":"wm_date_formatter","mobileColumn":false},{"show":true,"field":"serolinknumber","title":"Serolinknumber","width":"100%","align":"left","formatFunc":"","mobileColumn":false},{"show":true,"field":"age","title":"Age","width":"80px","align":"right","formatFunc":"","mobileColumn":false},{"show":true,"field":"gender","title":"Gender","width":"100%","align":"left","formatFunc":"","mobileColumn":false},{"show":true,"field":"bmi","title":"Bmi","width":"80px","align":"right","formatFunc":"","mobileColumn":false},{"show":true,"field":"clinicalcomplaint","title":"Clinicalcomplaint","width":"100%","align":"left","formatFunc":"","mobileColumn":false},{"show":true,"field":"pregnant","title":"Pregnant","width":"100%","align":"left","formatFunc":"","mobileColumn":false},{"show":true,"field":"insertby","title":"Insertby","width":"80px","align":"right","formatFunc":"","mobileColumn":false},{"show":true,"field":"insertdate","title":"Insertdate","width":"80px","align":"left","formatFunc":"wm_date_formatter","mobileColumn":false},{"show":false,"field":"PHONE COLUMN","title":"-","width":"100%","align":"left","expression":"\"<div class='MobileRowTitle'>Date: \" + wm.List.prototype.dateFormatter({}, null,null,null,${date}) + \"</div>\"\n+ \"<div class='MobileRow'>Serolinknumber: \" + ${serolinknumber} + \"</div>\"\n+ \"<div class='MobileRow'>Age: \" + ${age} + \"</div>\"\n+ \"<div class='MobileRow'>Gender: \" + ${gender} + \"</div>\"\n+ \"<div class='MobileRow'>Bmi: \" + ${bmi} + \"</div>\"\n+ \"<div class='MobileRow'>Clinicalcomplaint: \" + ${clinicalcomplaint} + \"</div>\"\n+ \"<div class='MobileRow'>Pregnant: \" + ${pregnant} + \"</div>\"\n+ \"<div class='MobileRow'>Insertby: \" + ${insertby} + \"</div>\"\n+ \"<div class='MobileRow'>Insertdate: \" + wm.List.prototype.dateFormatter({}, null,null,null,${insertdate}) + \"</div>\"\n","mobileColumn":true},{"show":false,"field":"clinician","title":"Clinician","width":"100%","align":"left","formatFunc":"","mobileColumn":false}],"dsType":"com.mcddb.data.ClinicalMain","height":"100%","margin":"4"}, {"onSelect":"clinicalmainLivePanel1.popupLivePanelEdit"}, {
binding: ["wm.Binding", {}, {}, {
...
dateEditor1: ["wm.DateTime", {"caption":"Date","captionSize":"140px","dateMode":"Date","desktopHeight":"26px","emptyValue":"zero","formField":"date","height":"26px","maximum":1369882800000,"minimum":1304046000000,"required":true,"width":"50%"}, {}],
...
bmiEditor1: ["wm.Number", {"caption":"BMI","captionSize":"140px","changeOnKey":true,"dataValue":0,"desktopHeight":"26px","emptyValue":"zero","formField":"bmi","height":"26px","maximum":50,"minimum":10,"placeHolder":"Valid BMI are between 10 and 50","showing":false,"width":"50%"}, {}],
...
General.prototype._cssText = '';
General.prototype._htmlText = '';