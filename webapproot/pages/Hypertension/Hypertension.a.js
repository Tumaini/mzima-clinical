...
hypertensionLiveVariable1: ["wm.LiveVariable", {"matchMode":"anywhere","orderBy":"desc:insertdate","type":"com.mcddb.data.Hypertension"}, {}, {
...
radioSet6: ["wm.RadioSet", {"caption":"Has participant had hypertension measurements taken?","captionSize":"140px","dataField":"dataValue","desktopHeight":"64px","displayField":"dataValue","displayValue":"","emptyValue":"null","height":"64px","options":"YES,NO","required":true,"width":"100%"}, {"onchange":"radioSet6Change"}],
...
radioSet1: ["wm.RadioSet", {"caption":"Does participant want to know blood pressure results?","captionSize":"140px","dataField":"dataValue","desktopHeight":"81px","displayField":"dataValue","emptyValue":"null","formField":"wanttoknowresults","height":"81px","options":"YES,NO,NOT TESTED","required":true,"width":"100%"}, {"onchange":"radioSet1Change"}],
radioSet7: ["wm.RadioSet", {"caption":"Has systolic measurements?","captionSize":"140px","dataField":"dataValue","desktopHeight":"56px","displayField":"dataValue","displayValue":"","emptyValue":"null","height":"56px","options":"YES,NO","required":true,"width":"100%"}, {"onchange":"radioSet7Change"}],
number1: ["wm.Number", {"caption":"Average systolic blood pressure (3 readings) mmHg","captionSize":"270px","desktopHeight":"35px","emptyValue":"null","formField":"avgsystolicbloodpressure","height":"35px","helpText":"Pressure should be between 19 and 251 mmHg","maximum":999,"minimum":19,"placeHolder":"Pressure should be between 19 and 251 mmHg","showing":false,"singleLine":false,"width":"70%"}, {}],
radioSet8: ["wm.RadioSet", {"caption":"Has diastolic measurements?","captionSize":"140px","dataField":"dataValue","desktopHeight":"56px","displayField":"dataValue","displayValue":"","emptyValue":"null","height":"56px","options":"YES,NO","required":true,"width":"100%"}, {"onchange":"radioSet8Change"}],
number2: ["wm.Number", {"caption":"Average diastolic blood pressure (3 readings) mmHg","captionSize":"270px","desktopHeight":"35px","emptyValue":"null","formField":"avgdiastolicbloodpressure","height":"35px","helpText":"Pressure should be between 19 and 251 mmHg","maximum":999,"minimum":19,"placeHolder":"Pressure should be between 19 and 251 mmHg","showing":false,"singleLine":false,"width":"70%"}, {}],
radioSet2: ["wm.RadioSet", {"caption":"Is participant a known hypertensive?","captionSize":"140px","dataField":"dataValue","desktopHeight":"56px","displayField":"dataValue","emptyValue":"null","formField":"knownhypertensive","height":"56px","options":"YES,NO","required":true,"width":"100%"}, {"onchange":"radioSet2Change"}],
radioSet3: ["wm.RadioSet", {"caption":"If ‘yes’ is the participant on treatment/in care?","captionSize":"140px","dataField":"dataValue","desktopHeight":"56px","displayField":"dataValue","emptyValue":"null","formField":"intreatment","height":"56px","options":"YES,NO","showing":false,"width":"100%"}, {}],
...
radioSet4: ["wm.RadioSet", {"caption":"Is physical exam to be performed?","captionSize":"140px","dataField":"dataValue","desktopHeight":"56px","displayField":"dataValue","emptyValue":"null","formField":"physicalexam","height":"56px","options":"YES,NO","required":true,"width":"100%"}, {"onchange":"radioSet4Change"}],
radioSet5: ["wm.RadioSet", {"caption":"Is participant to be referred?","captionSize":"140px","dataField":"dataValue","desktopHeight":"55px","displayField":"dataValue","emptyValue":"null","formField":"referral","height":"55px","options":"YES,NO","required":true,"width":"100%"}, {"onchange":"radioSet5Change"}],
...
selectMenu1: ["wm.SelectMenu", {"caption":"Clinician","captionSize":"140px","dataField":"dataValue","desktopHeight":"26px","displayField":"dataValue","emptyValue":"null","formField":"clinician","height":"26px","options":"DNN,GEM,IHU,LAN,SRA,WEL","required":true,"width":"50%"}, {"onchange":"selectMenu1Change"}, {
binding: ["wm.Binding", {}, {}, {
...
Hypertension.prototype._cssText = '';
Hypertension.prototype._htmlText = '';